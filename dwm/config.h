...
/* appearance */
static const unsigned int borderpx  = 8;        /* border pixel size of windows */
static const unsigned int gappx     = 20;        /* gaps size between windows */
static const unsigned int snap      = 32;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "FiraCode-Regular:size=14", "fontawesome:size=12", "NotoColorEmoji:size=12" };
static const char dmenufont[]       = "FiraCode-Regular:size=12";
//background color
